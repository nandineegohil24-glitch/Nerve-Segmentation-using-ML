...
# ---------------------------
def attention_unet(input_size=(IMG_SIZE, IMG_SIZE, 1)):
    ...
    g4 = layers.Conv2D(256, 1, activation='relu', padding='same')(c5)
    ...
    g3 = layers.Conv2D(128, 1, activation='relu', padding='same')(c6)
    ...
    g2 = layers.Conv2D(64, 1, activation='relu', padding='same')(c7)
    ...
    g1 = layers.Conv2D(32, 1, activation='relu', padding='same')(c8)
...
overlay[pred_mask==255] = [255, 0, 0]  # red prediction
...
# 7. Save Model
# ---------------------------
model.save("attention_unet.h5")
print("✅ Attention U-Net trained and saved as attention_unet.h5")
