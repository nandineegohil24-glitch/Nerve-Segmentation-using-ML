...
# ---------------------------
IMG_SIZE = 128
DATASET_PATH = "dataset/train"   # ✅ same as your code
BATCH_SIZE = 8
EPOCHS = 20
LR = 1e-4

# ---------------------------
# 2. Load Dataset (OpenCV + resize)
# ---------------------------
X, y = [], []
...
y = np.array(y, dtype=np.float32).reshape(-1, IMG_SIZE, IMG_SIZE)
...
# ---------------------------
# 4. Model (U-Net with ResNet34 backbone)
# ---------------------------
...
class DiceLoss(nn.Module):
    def forward(self, inputs, targets, smooth=1):
        inputs = torch.softmax(inputs, dim=1)[:,1,:,:]  # class 1 probs
